...
pub struct SubscriptionCreateParams<'a> {
    /// A non-negative decimal between 0 and 100, with at most two decimal places.
    ///
    /// This represents the percentage of the subscription invoice subtotal that will be transferred to the application owner's Stripe account.
    ...
    /// List of subscription items, each with an attached plan.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<SubscriptionCreateParamsItems>>,
...
pub struct SubscriptionUpdateParams<'a> {
    ...
    /// List of subscription items, each with an attached plan.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<SubscriptionUpdateParamsItems>>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SubscriptionCreateParamsItems {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SubscriptionUpdateParamsItems {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_thresholds: Option<SubscriptionItemBillingThresholds>,
...
/// An enum representing the possible values of an `SubscriptionUpdateParams`'s `billing_cycle_anchor` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
