...
pub struct ChargeCreateParams<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shipping: Option<ChargeCreateParamsShipping>,
    ...
    /// [See the Connect documentation](https://stripe.com/docs/connect/destination-charges) for details.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer_data: Option<ChargeCreateParamsTransferData>,
...
pub struct ChargeUpdateParams<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fraud_details: Option<ChargeUpdateParamsFraudDetails>,
    ...
    /// Helps prevent fraud on charges for physical goods.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shipping: Option<ChargeUpdateParamsShipping>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeCreateParamsShipping {
    pub address: ChargeCreateParamsShippingAddress,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeCreateParamsTransferData {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub amount: Option<i64>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeUpdateParamsFraudDetails {
    pub user_report: ChargeUpdateParamsFraudDetailsUserReport,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeUpdateParamsShipping {
    pub address: ChargeUpdateParamsShippingAddress,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeCreateParamsShippingAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ChargeUpdateParamsShippingAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub city: Option<String>,
...
/// An enum representing the possible values of an `ChargeUpdateParamsFraudDetails`'s `user_report` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum ChargeUpdateParamsFraudDetailsUserReport {
    Fraudulent,
    Safe,
}
