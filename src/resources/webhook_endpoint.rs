...
pub struct WebhookEndpointCreateParams<'a> {
    ...
    ///
    /// You may specify `['*']` to enable all events.
    pub enabled_events: Vec<WebhookEndpointCreateParamsEnabledEvents>,
...
#[derive(Clone, Debug, Serialize)]
pub struct WebhookEndpointListParams<'a> {
...
#[derive(Clone, Debug, Serialize)]
pub struct WebhookEndpointUpdateParams<'a> {
    ...
    /// You may specify `['*']` to enable all events.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub enabled_events: Option<Vec<WebhookEndpointUpdateParamsEnabledEvents>>,
...
/// An enum representing the possible values of an `WebhookEndpointCreateParams`'s `enabled_events` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum WebhookEndpointCreateParamsEnabledEvents {
    #[serde(rename = "*")]
    All,
    #[serde(rename = "account.application.authorized")]
    AccountApplicationAuthorized,
...
/// An enum representing the possible values of an `WebhookEndpointUpdateParams`'s `enabled_events` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum WebhookEndpointUpdateParamsEnabledEvents {
    #[serde(rename = "*")]
    All,
    #[serde(rename = "account.application.authorized")]
    AccountApplicationAuthorized,
