...
pub struct PaymentMethodCreateParams<'a> {
    /// Billing information associated with the PaymentMethod that may be used or required by particular types of payment methods.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_details: Option<PaymentMethodCreateParamsBillingDetails>,
...
#[derive(Clone, Debug, Serialize)]
pub struct PaymentMethodUpdateParams<'a> {
    /// Billing information associated with the PaymentMethod that may be used or required by particular types of payment methods.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_details: Option<PaymentMethodUpdateParamsBillingDetails>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PaymentMethodCreateParamsBillingDetails {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PaymentMethodCreateParamsBillingDetailsAddress>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PaymentMethodUpdateParamsBillingDetails {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PaymentMethodUpdateParamsBillingDetailsAddress>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PaymentMethodCreateParamsBillingDetailsAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PaymentMethodUpdateParamsBillingDetailsAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub city: Option<String>,
