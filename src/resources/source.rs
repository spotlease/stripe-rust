...
pub struct SourceCreateParams<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mandate: Option<SourceCreateParamsMandate>,
...
#[derive(Clone, Debug, Serialize)]
pub struct SourceUpdateParams<'a> {
    /// Specifies which fields in the response should be expanded.
    #[serde(skip_serializing_if = "Expand::is_empty")]
    pub expand: &'a [&'a str],
    ...
    /// Information about a mandate possibility attached to a source object (generally for bank debits) as well as its acceptance status.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mandate: Option<SourceUpdateParamsMandate>,
    ...
    /// Information about the owner of the payment instrument that may be used or required by particular source types.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub owner: Option<SourceUpdateParamsOwner>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsMandate {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub acceptance: Option<SourceCreateParamsMandateAcceptance>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub interval: Option<SourceCreateParamsMandateInterval>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub notification_method: Option<SourceCreateParamsMandateNotificationMethod>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsOwner {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<SourceCreateParamsOwnerAddress>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsReceiver {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub refund_attributes_method: Option<SourceCreateParamsReceiverRefundAttributesMethod>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsRedirect {
    pub return_url: String,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsMandate {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub acceptance: Option<SourceUpdateParamsMandateAcceptance>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub interval: Option<SourceUpdateParamsMandateInterval>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub notification_method: Option<SourceUpdateParamsMandateNotificationMethod>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsOwner {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<SourceUpdateParamsOwnerAddress>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsMandateAcceptance {
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub offline: Option<SourceCreateParamsMandateAcceptanceOffline>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub online: Option<SourceCreateParamsMandateAcceptanceOnline>,

    pub status: SourceCreateParamsMandateAcceptanceStatus,

    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_: Option<SourceCreateParamsMandateAcceptanceType>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsOwnerAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsMandateAcceptance {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub date: Option<Timestamp>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub offline: Option<SourceUpdateParamsMandateAcceptanceOffline>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub online: Option<SourceUpdateParamsMandateAcceptanceOnline>,

    pub status: SourceUpdateParamsMandateAcceptanceStatus,

    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_: Option<SourceUpdateParamsMandateAcceptanceType>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsOwnerAddress {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub city: Option<String>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsMandateAcceptanceOffline {
    pub contact_email: String,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceCreateParamsMandateAcceptanceOnline {
    pub date: Timestamp,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsMandateAcceptanceOffline {
    pub contact_email: String,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SourceUpdateParamsMandateAcceptanceOnline {
    pub date: Timestamp,
...
/// An enum representing the possible values of an `SourceCreateParamsMandateAcceptance`'s `status` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceCreateParamsMandateAcceptanceStatus {
    Accepted,
    Pending,
    Refused,
    Revoked,
...
/// An enum representing the possible values of an `SourceCreateParamsMandateAcceptance`'s `type` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceCreateParamsMandateAcceptanceType {
    Offline,
    Online,
}

/// An enum representing the possible values of an `SourceCreateParamsMandate`'s `interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceCreateParamsMandateInterval {
    OneTime,
    Scheduled,
    Variable,
}

/// An enum representing the possible values of an `SourceCreateParamsMandate`'s `notification_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceCreateParamsMandateNotificationMethod {
    DeprecatedNone,
    Email,
    Manual,
    None,
...
/// An enum representing the possible values of an `SourceCreateParamsReceiver`'s `refund_attributes_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceCreateParamsReceiverRefundAttributesMethod {
    Email,
    Manual,
    None,
}
...
/// An enum representing the possible values of an `SourceUpdateParamsMandateAcceptance`'s `status` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceUpdateParamsMandateAcceptanceStatus {
    Accepted,
    Pending,
    Refused,
    Revoked,
...
/// An enum representing the possible values of an `SourceUpdateParamsMandateAcceptance`'s `type` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceUpdateParamsMandateAcceptanceType {
    Offline,
    Online,
}

/// An enum representing the possible values of an `SourceUpdateParamsMandate`'s `interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceUpdateParamsMandateInterval {
    OneTime,
    Scheduled,
    Variable,
}

/// An enum representing the possible values of an `SourceUpdateParamsMandate`'s `notification_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum SourceUpdateParamsMandateNotificationMethod {
    DeprecatedNone,
    Email,
    Manual,
    None,
